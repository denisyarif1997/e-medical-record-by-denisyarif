    ...
    <div class="container-fluid mt-3">
        <div class="card shadow-sm border-0">
            <div class="card-header bg-gradient-primary text-white py-3">
                <h3 class="card-title font-weight-bold"><i class="fas fa-user-nurse mr-2"></i> Edit Asesmen Perawat</h3>
            </div>
            ...
            <div class="card-body bg-light">
                <form action="{{ route('admin.asesmen_perawat.update', $asesmen->id) }}" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="text-secondary font-weight-bold">ID Registrasi</label>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control text-primary font-weight-bold" value="{{ $regis->no_rekam_medis }}" readonly>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
            ...
            <div class="card shadow-sm border-0 mt-4">
                <div class="card-header bg-gradient-info text-white py-3">
                    <h3 class="card-title font-weight-bold"><i class="fas fa-notes-medical mr-2"></i> Formulir Edit Asesmen Keperawatan</h3>
                </div>
                <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea name="riwayat_alergi" class="form-control" rows="2" placeholder="Sebutkan alergi obat, makanan, dll (Jika ada)">{{ $a['riwayat_alergi'] ?? '' }}</textarea>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label><strong>Riwayat Penyakit Dahulu/Keluarga</strong></label>
                                        <textarea name="riwayat_penyakit" class="form-control" rows="2" placeholder="Hipertensi, DM, Jantung, dll">{{ $a['riwayat_penyakit'] ?? '' }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="pemeriksaan_fisik" class="form-control" rows="3" placeholder="Deskripsikan kondisi fisik pasien secara umum">{{ $a['pemeriksaan_fisik'] ?? '' }}</textarea>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label><strong>Keadaan Umum</strong> <span class="text-danger">*</span></label>
                                        <input type="text" name="keadaan_umum" class="form-control" value="{{ $a['keadaan_umum'] ?? '' }}" required placeholder="Baik / Lemah / Cukup">
                                    </div>
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input type="number" name="sistolik" class="form-control" value="{{ $a['sistolik'] ?? '' }}" placeholder="mmHg">
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input type="number" name="diastolik" class="form-control" value="{{ $a['diastolik'] ?? '' }}" placeholder="mmHg">
                                                    <div class="input-group-append"><span class="input-group-text">mmHg</span></div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input type="number" name="nadi" class="form-control" value="{{ $a['nadi'] ?? '' }}" placeholder="x/mnt">
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input type="number" name="pernapasan" class="form-control" value="{{ $a['pernapasan'] ?? '' }}" placeholder="x/mnt">
                                                    <div class="input-group-append"><span class="input-group-text">x/mnt</span></div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-4">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input type="number" step="0.1" name="suhu" class="form-control" value="{{ $a['suhu'] ?? '' }}" placeholder="°C">
                                        ...
                                        <div class="col-4">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input type="number" step="0.1" name="tinggi_badan" class="form-control" value="{{ $a['tinggi_badan'] ?? '' }}" placeholder="cm">
                                        ...
                                        <div class="col-4">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input type="number" step="0.1" name="berat_badan" class="form-control" value="{{ $a['berat_badan'] ?? '' }}" placeholder="kg">
                                    ...
                                    <div class="form-group mt-2">
                                        ...
                                        <div class="input-group">
                                            <input type="text" name="imt" id="imt" class="form-control font-weight-bold" value="{{ $a['imt'] ?? '' }}" readonly style="background-color: #f8f9fa;">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <select name="status_psikososial" class="form-control">
                                            @foreach(['Tenang', 'Cemas', 'Sedih', 'Marah', 'Takut', 'Lainnya'] as $st)
                                                <option value="{{ $st }}" {{ ($a['status_psikososial'] ?? '') == $st ? 'selected' : '' }}>{{ $st }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <select name="adl_status" class="form-control">
                                            @foreach(['Mandiri', 'Bantuan Minimal', 'Bantuan Parsial', 'Bantuan Total'] as $adl)
                                                <option value="{{ $adl }}" {{ ($a['adl_status'] ?? '') == $adl ? 'selected' : '' }}>{{ $adl }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="card card-outline card-warning h-100 border-left-3">
                                ...
                                <div class="card-body">
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <select name="jatuh_risiko" class="form-control">
                                                    @foreach(['Tidak Berisiko', 'Risiko Rendah', 'Risiko Tinggi'] as $jr)
                                                        <option value="{{ $jr }}" {{ ($a['jatuh_risiko'] ?? '') == $jr ? 'selected' : '' }}>{{ $jr }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <input type="range" name="nyeri_skala" id="nyeri_skala" class="custom-range flex-grow-1" min="0" max="10" value="{{ $a['nyeri_skala'] ?? 0 }}">
                                                    <span id="nyeri_val" class="badge badge-success text-white ml-3 px-3 py-2 font-weight-bold" style="font-size: 1.1rem; width: 45px; text-align: center;">{{ $a['nyeri_skala'] ?? 0 }}</span>
                                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nyeri_kualitas" class="form-control" value="{{ $a['nyeri_kualitas'] ?? '' }}" placeholder="Contoh: Seperti ditusuk, tumpul, panas">
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="gizi_mst_1" id="gizi_mst_1" class="form-control">
                                            @php
                                                $mst1_opts = [
                                                    '0' => 'Tidak (Skor 0)',
                                                    '1' => 'Tidak yakin / Baju terasa longgar (Skor 1)',
                                                    '2' => 'Ya, 1-5 kg (Skor 2)',
                                                    '3' => 'Ya, 6-10 kg (Skor 3)',
                                                    '4' => 'Ya, 11-15 kg (Skor 4)',
                                                    '5' => 'Ya, > 15 kg (Skor 5)'
                                                ];
                                            @endphp
                                            @foreach($mst1_opts as $val => $txt)
                                                <option value="{{ $val }}" {{ ($a['gizi_mst_1'] ?? '') == $val ? 'selected' : '' }}>{{ $txt }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="gizi_mst_2" id="gizi_mst_2" class="form-control">
                                            <option value="0" {{ ($a['gizi_mst_2'] ?? '') == '0' ? 'selected' : '' }}>Tidak (Skor 0)</option>
                                            <option value="1" {{ ($a['gizi_mst_2'] ?? '') == '1' ? 'selected' : '' }}>Ya (Skor 1)</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card card-outline card-secondary mt-3 border-left-3">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <div class="row">
                                    @php
                                        $selected_masalah = $a['masalah_keperawatan'] ?? [];
                                        $available_masalah = [
                                    ...
                                    @endphp
                                    @foreach($available_masalah as $masalah)
                                    <div class="col-md-4">
                                        <div class="custom-control custom-checkbox my-1">
                                            <input class="custom-control-input" type="checkbox" name="masalah_keperawatan[]" id="masalah_{{ $loop->index }}" value="{{ $masalah }}" {{ in_array($masalah, $selected_masalah) ? 'checked' : '' }}>
                            ...
                            <div class="form-group mt-3">
                                ...
                                <textarea name="rencana_keperawatan" class="form-control" rows="3" placeholder="Sebutkan intervensi singkat yang akan dilakukan">{{ $a['rencana_keperawatan'] ?? '' }}</textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="text-right mt-4 pb-4">
                        ...
                        <button type="submit" class="btn btn-primary shadow-sm px-4"><i class="fas fa-save mr-1"></i> Perbarui Asesmen</button>
                    </div>
                </form>
            </div>
        </div>
