<nav class="mt-2">
    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li
            class="nav-item has-treeview {{ Route::is('admin.dokter.index') || Route::is('admin.spesialis.index') || Route::is('admin.asuransi.index') || Route::is('admin.poliklinik.index') || Route::is('admin.obat.index') || Route::is('admin.satuan_obat.index') || Route::is('admin.procedures.index') || Route::is('admin.js_procedures.index') ||Route::is('forms.jenis_harga') ? 'menu-open' : '' }}">
            <a href="#"
                class="nav-link {{ Route::is('admin.dokter.index') || Route::is('admin.spesialis.index') || Route::is('admin.asuransi.index') || Route::is('admin.poliklinik.index') || Route::is('admin.obat.index') || Route::is('admin.satuan_obat.index') || Route::is('admin.procedures.index') || Route::is('admin.js_procedures.index') || Route::is('forms.jenis_harga')? 'active' : '' }}">
    ...
    class="nav-item has-treeview 
        {{ Route::is('admin.procedures.*') || 
           Route::is('admin.js_procedures.*') || 
           Route::is('forms.jenis_harga') ? 'menu-open' : '' }}">
    <a href="#"
        class="nav-link 
            {{ Route::is('admin.procedures.*') || 
               Route::is('admin.js_procedures.*') || 
               Route::is('forms.jenis_harga') ? 'active' : '' }}">
    ...
    <ul class="nav nav-treeview">
        ...
        <li class="nav-item">
            <a href="{{ route('forms.jenis_harga') }}"
                ...
                <li
                    class="nav-item has-treeview {{ Route::is('admin.obat.*') || Route::is('admin.satuan_obat.*') ? 'menu-open' : '' }}">
                    <a href="#"
                        class="nav-link {{ Route::is('admin.obat.*') || Route::is('admin.satuan_obat.*') ? 'active' : '' }}">
